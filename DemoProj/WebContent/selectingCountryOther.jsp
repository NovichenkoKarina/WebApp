...
<body>
<h1 align="center">Clients from other country</h1>
<%! 
public class Client {
...
public Client(){
	...
	try{
		...
		selectClients = connection.prepareStatement("SELECT clientId, clientName, clientAge, clientCountry, clientNumber FROM client WHERE clientCountry!='Беларусь' AND clientCountry!='Россия'");
