...
<body>
<h1 align="center">Clients from Belarus</h1>
<%! 
public class Client {
...
public Client(){
	...
	try{
		...
		selectClients = connection.prepareStatement("SELECT clientId, clientName, clientAge, clientCountry, clientNumber FROM client WHERE clientCountry='Беларусь'");
